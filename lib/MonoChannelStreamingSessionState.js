...
const logger = require('pino')({ 
    level: LOG_LEVEL,
    name: 'MonoChannelStreamingSessionState'
});

class MonoChannelStreamingSessionState extends StreamingSessionState {
...
module.exports = MonoChannelStreamingSessionState;